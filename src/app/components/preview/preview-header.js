...
export default function PreviewHeader() {
    ...
    return (
        ...
        md:w-[95%] md:left-1/2 md:transform md:-translate-x-1/2 md:justify-between md:rounded-xl md:top-4">
            ...
            text-customPurple w-2/5 py-2 rounded-lg text-center md:w-1/6 md:ml-4 md:mb-4">Back to Editor</Link>
            <button className="mt-5 bg-customPurple text-customWhite w-2/5 py-2 rounded-lg md:w-1/6 md:mr-4 md:mb-4"
